const CFB_QUICK = {
  ...
  2: ["A 50-point FCS win is not a license to lay 35-plus the next Friday.","Missouri -5.5 on the road was a real game. 3-to-7 ranked sides are live."]
};
const CFB_WEEK_NOTES = {
  ...
  2: {
    held: ["Miami, Louisville, Virginia covered 36-plus FCS numbers. The number cashed. The stamp stays FADE.","Missouri -5.5 on the road was a real game and covered."],
