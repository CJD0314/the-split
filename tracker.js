...
async function loadLedger(){
  ...
  const shards = ["tracker-settled.json","tracker-settled-2.json","tracker-open.json","tracker-nfl-w1.json","tracker-nfl-w2.json","tracker-nfl-mnf.json","tracker-nfl-tnf.json","tracker-mlb-914.json","tracker-mlb-915.json","tracker-mlb-916.json","tracker-cfb-w3.json"];
