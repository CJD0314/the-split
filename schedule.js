...
[3,"THU 8:15 Prime","atl","gb","Falcons at Packers","8:15 p.m. ET · Lambeau · T-90 locked","ATL +4.5 / GB -4.5","42.5","GB -245 / ATL +200","PASS · $100 SE locked","nfl-week-3-atl-gb.html",""],
...
function nflCard(g){
  ...
  const dive = DIVE_READY[href] ? `<a class="g-btn g-btn-on" href="${href}?v=7">FULL BREAKDOWN</a>` : "";
