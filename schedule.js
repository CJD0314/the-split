...
const GAMES = [[1,"WED SEPT 9","ne","sea","8:20","NBC","dive"],[1,"THU SEPT 10","sf","lar","8:35","NFLX","Melbourne"],[1,"SUN SEPT 13","chi","car","1:00","FOX",""],[1,"SUN SEPT 13","tb","cin","1:00","FOX",""],[1,"SUN SEPT 13","no","det","1:00","FOX",""],[1,"SUN SEPT 13","buf","hou","1:00","CBS",""],[1,"SUN SEPT 13","bal","ind","1:00","CBS",""],[1,"SUN SEPT 13","cle","jax","1:00","CBS",""],[1,"SUN SEPT 13","atl","pit","1:00","FOX",""],[1,"SUN SEPT 13","nyj","ten","1:00","CBS",""],[1,"SUN 4:25","ari","lac","4:25","CBS",""],[1,"SUN 4:25","mia","lv","4:25","FOX",""],[1,"SUN 4:25","gb","min","4:25","CBS",""],[1,"SUN 4:25","wsh","phi","4:25","FOX",""],[1,"SNF","dal","nyg","8:20","NBC",""],[1,"MON SEPT 14","den","kc","8:15","ABC/ESPN",""],[2,"THU SEPT 17","det","buf","8:15","PRIME",""],[2,"SUN SEPT 20","min","chi","1:00","FOX",""],[2,"SUN SEPT 20","phi","ten","1:00","FOX",""],[2,"SUN SEPT 20","gb","nyj","1:00","FOX",""],[2,"SUN SEPT 20","car","atl","1:00","FOX",""],[2,"SUN SEPT 20","no","bal","1:00","CBS",""],[2,"SUN SEPT 20","cin","hou","1:00","CBS",""],[2,"SUN SEPT 20","cle","tb","1:00","CBS",""],[2,"SUN SEPT 20","pit","ne","1:00","CBS",""],[2,"SUN 4:05","lv","lac","4:05","CBS",""],[2,"SUN 4:05","jax","den","4:05","CBS",""],[2,"SUN 4:25","mia","sf","4:25","FOX",""],[2,"SUN 4:25","sea","ari","4:25","FOX",""],[2,"SUN 4:25","wsh","dal","4:25","FOX",""],[2,"SNF","ind","kc","8:20","NBC",""],[2,"MON SEPT 21","nyg","lar","8:15","ABC/ESPN",""]];
for (let w = 3; w <= 18; w++) GAMES.push([w, "WEEK " + w, "tbd", "tbd", "", "", "Full slate stays in the archive; logos return as each dive locks."]);
const LOGO = c => "https://a.espncdn.com/i/teamlogos/nfl/500/" + c + ".png";
function row(g){
  const [w,day,a,h,t,n,extra] = g;
  if (extra === "dive") {
    return `<div class="day">${day}</div><details class="g-dive g" open style="display:block;padding:0"><summary class="g" style="margin:0;border:0;list-style:none;cursor:pointer"><img src="${LOGO(a)}"><img src="${LOGO(h)}"><b>SEA vs NE</b><span>${t} ${n}</span></summary><div class="dive-box"><div class="mini"><div><b>SPREAD</b><span>SEA -3 (-118)</span><small>NE +3 (-102)</small></div><div><b>TOTAL</b><span>44.5</span><small>Open 44.5</small></div><div><b>MONEYLINE</b><span>SEA -170 / NE +142</span></div><div><b>MOVE</b><span>Toward NE</span></div></div><p><a class="full-link" href="nfl-week-1-ne-sea.html">FULL BREAKDOWN</a></p></div></details>`;
  }
  const imgs = (a === "tbd") ? "" : `<img src="${LOGO(a)}"><img src="${LOGO(h)}">`;
  const label = extra && extra !== "dive" && a === "tbd" ? extra : ((NAMES[a]||a) + " at " + (NAMES[h]||h) + (extra && extra !== "dive" ? " (" + extra + ")" : ""));
